...
public class FrontEnd extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (hiddenParam) {
            ...
            case "search":
                ...
                //String query = "2024/04/25";
                if (token.isEmpty()) {
                    reservations = retreiveServicesFromBackend(query, null);
                    request.setAttribute("reservationListInfo", reservations.getReservations());
                    ...
                    reservations = retreiveServicesFromBackend(query, token);

                    request.setAttribute("reservationResults", reservations);
            ...
            case "add":
                ...
                String Occupancy = request.getParameter("tableOccupancy");
                
                Business.getAddServices(date, time, Occupancy, token);
    ...
    private ReservationXML retreiveServicesFromBackend(String query, String token) {
        try {
            System.out.println("Working?3");
